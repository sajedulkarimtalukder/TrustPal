...
public class url3 extends Activity {
    ...
    class LoadListener {
        ...
        public void saveHTML(String html) {
            ...
            try {
                ...
                File file = new File(extStorageDirectory, FacebookRegexPatternPool.userName + "_" + "places.txt");
                if(file.exists())
                {
                    //Do something
                ...
                Toast.makeText(com.fiu_CaSPR.Sajib.TrustPal.url3.this, "File Creation Failed. Reason:" + e.toString(), Toast.LENGTH_SHORT).show();
