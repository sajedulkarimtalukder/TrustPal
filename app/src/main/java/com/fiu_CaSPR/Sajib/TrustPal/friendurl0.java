...
public class friendurl0 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.friend_fetch_0);
        ...
        public void saveHTML(String html) {
            ...
            try {
                ...
                if(file.exists())
                {
                    ...
                    outputStream.close();
                    //Toast.makeText(com.fiu_CaSPR.Frank.safebuk.url0.this, "20% done", Toast.LENGTH_SHORT).show();
                }
                //Toast.makeText(friendurl0.this, "About file Saved Successfully", Toast.LENGTH_SHORT).show();
                Intent intent = new Intent(getApplicationContext(), friendurl1.class);
                intent.putExtra("username",username);
                startActivity(intent);


            } catch (IOException e) {
                Toast.makeText(friendurl0.this, "File Creation Failed. Reason:" + e.toString(), Toast.LENGTH_SHORT).show();
