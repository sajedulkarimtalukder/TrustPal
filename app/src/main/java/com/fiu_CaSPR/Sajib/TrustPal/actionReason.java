...
public class actionReason extends Activity {
    ...
    private int totalCountForReview = 19;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.action_reason_old);
        checkboxes = new ArrayList<CheckBox>();
        totalCount = 19;

        //totalCountForReview = getTotalCount();
        currentPictureIndex = 16;
        loadViews();
    ...
    private void loadViews() {
        ...
        nextButton.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(clickcount<5) {
                    Toast.makeText(actionReason.this, "Please answer all questions before proceeding!", Toast.LENGTH_SHORT).show();
                }
                else {
                    next_button_time = System.nanoTime();
                    double difference = (next_button_time - start_time) / 1e6;
                    setAction();
                    //responseString+=currentPictureIndex+1;
    ...
    private void doLastJob() {
        ...
        Intent intent = new Intent(getApplicationContext(),puzzle5.class);
    ...
    private void loadNextFriendView() {
        ...
        new FacebookGetUserImage(imageUrl,5).execute(friendsPage.friendsArray[currentPictureIndex][0]);
