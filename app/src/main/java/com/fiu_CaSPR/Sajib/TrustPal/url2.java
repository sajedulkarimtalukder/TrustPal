...
public class url2 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.url_fetch_2);
    ...
    class LoadListener {
        ...
        public void saveHTML(String html) {
            ...
            try {
                ...
                File file = new File(extStorageDirectory, FacebookRegexPatternPool.userName + "_" + "overview.txt");
                if(file.exists())
                {
                    //Do something
                ...
                Toast.makeText(com.fiu_CaSPR.Sajib.TrustPal.url2.this, "File Creation Failed. Reason:" + e.toString(), Toast.LENGTH_SHORT).show();
