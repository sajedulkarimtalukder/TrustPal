...
public class FriendSelectorView5 extends Activity {
    ...
    private void loadViews() {
        ...
        nextButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(clickcount<5) {
                    Toast.makeText(FriendSelectorView5.this, "Please answer all questions before proceeding!", Toast.LENGTH_SHORT).show();
                }
                else {
    ...
    private void loadNextFriendView() {
        ...
        new DownloadImageTask(FriendSelectorView5.propicView).execute(friendsPage.friendsArray[currentPictureIndex][25]);
