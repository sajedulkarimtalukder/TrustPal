...
public class friendurl4 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        url4= "https://www.facebook.com/" + FacebookRegexPatternPool.userName + "/" + username + "/";
        setContentView(R.layout.friend_fetch_4);
    ...
    class LoadListener {
        ...
        public void saveHTML(String html) {
            ...
            try {
                ...
                File file = new File(extStorageDirectory, username + "_" + "mutual.txt");
                if(file.exists())
                {
                    //Do something
                ...
                Toast.makeText(friendurl4.this, "File Creation Failed. Reason:" + e.toString(), Toast.LENGTH_SHORT).show();
