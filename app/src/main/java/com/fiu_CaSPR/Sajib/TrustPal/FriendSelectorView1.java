...
public class FriendSelectorView1 extends Activity {
    ...
    private int totalCountForReview = 3;
    ...
    private void loadViews() {
        ...
        nextButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(clickcount<5) {
                    Toast.makeText(FriendSelectorView1.this, "Please answer all questions before proceeding!", Toast.LENGTH_SHORT).show();
                }
                else {
    ...
    private void loadNextFriendView() {
        ...
        new DownloadImageTask(FriendSelectorView1.propicView).execute(friendsPage.friendsArray[currentPictureIndex][25]);
