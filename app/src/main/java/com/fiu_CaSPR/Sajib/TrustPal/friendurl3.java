...
public class friendurl3 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        url3= "https://www.facebook.com/" + username + "/places_recent";
        setContentView(R.layout.friend_fetch_3);
        ...
        wv.loadUrl(url3);
        //Toast.makeText(url3.this, "page 3 started", Toast.LENGTH_SHORT).show();
        ...
        wv.setWebChromeClient(new WebChromeClient() {
            public void onProgressChanged(WebView view, int progress) {
                ...
                /*if(progress==100)
                {
                    Intent intent = new Intent(getApplicationContext(), url4.class);
    ...
    class LoadListener {
        ...
        public void saveHTML(String html) {
            ...
            try {
                ...
                File file = new File(extStorageDirectory, username + "_" + "places.txt");
                if(file.exists())
                {
                    //Do something
                    ...
                    outputStream.close();
                    //Toast.makeText(url3.this, "80% done", Toast.LENGTH_SHORT).show();
                }
                //Toast.makeText(friendurl0.this, "About file Saved Successfully", Toast.LENGTH_SHORT).show();
                Intent intent = new Intent(getApplicationContext(), friendurl4.class);
                intent.putExtra("username", username);
                startActivity(intent);


            } catch (IOException e) {
                Toast.makeText(friendurl3.this, "File Creation Failed. Reason:" + e.toString(), Toast.LENGTH_SHORT).show();
