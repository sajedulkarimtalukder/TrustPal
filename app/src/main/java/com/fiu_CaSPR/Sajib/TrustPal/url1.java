...
public class url1 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.url_fetch_1);
    ...
    class LoadListener {
        ...
        public void saveHTML(String html) {
            ...
            try {
                ...
                Toast.makeText(com.fiu_CaSPR.Sajib.TrustPal.url1.this, "File Creation Failed. Reason:" + e.toString(), Toast.LENGTH_SHORT).show();
