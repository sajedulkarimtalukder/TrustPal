...
public class puzzle5 extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        name11.setText(friendsPage.friendsArray[16][1]);
        name21.setText(friendsPage.friendsArray[17][1]);
        name31.setText(friendsPage.friendsArray[18][1]);
        name41.setText(friendsPage.friendsArray[19][1]);

        new FacebookGetUserImage(FriendSelectorView5.imageUrl,51).execute(friendsPage.friendsArray[16][0]);
        new FacebookGetUserImage(FriendSelectorView5.imageUrl,52).execute(friendsPage.friendsArray[17][0]);
        new FacebookGetUserImage(FriendSelectorView5.imageUrl,53).execute(friendsPage.friendsArray[18][0]);
        new FacebookGetUserImage(FriendSelectorView5.imageUrl,54).execute(friendsPage.friendsArray[19][0]);
        ...
        name12.setText(friendsPage.friendsArray[16][1]);
        name22.setText(friendsPage.friendsArray[17][1]);
        name32.setText(friendsPage.friendsArray[18][1]);
        name42.setText(friendsPage.friendsArray[19][1]);

        new FacebookGetUserImage(FriendSelectorView5.imageUrl,55).execute(friendsPage.friendsArray[16][0]);
        new FacebookGetUserImage(FriendSelectorView5.imageUrl,56).execute(friendsPage.friendsArray[17][0]);
        new FacebookGetUserImage(FriendSelectorView5.imageUrl,57).execute(friendsPage.friendsArray[18][0]);
        new FacebookGetUserImage(FriendSelectorView5.imageUrl,58).execute(friendsPage.friendsArray[19][0]);
    ...
    private void saveJsonStringToFile() {
        ...
        try {
            ...
            File file1 = new File(extStorageDirectory, FacebookRegexPatternPool.Name+"_response_puzzle_"+".txt");
    ...
    private String createJsonString() {
        String newString = "";
        newString+=puzzle1.responseString;
        return newString;
    }
