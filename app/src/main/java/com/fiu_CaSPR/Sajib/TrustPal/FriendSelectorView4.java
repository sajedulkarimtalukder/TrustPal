...
public class FriendSelectorView4 extends Activity {
    ...
    private int totalCountForReview = 15;
    ...
    private void loadViews() {
        ...
        nextButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(clickcount<5) {
                    Toast.makeText(FriendSelectorView4.this, "Please answer all questions before proceeding!", Toast.LENGTH_SHORT).show();
                }
                else {
    ...
    private void loadNextFriendView() {
        ...
        new DownloadImageTask(FriendSelectorView4.propicView).execute(friendsPage.friendsArray[currentPictureIndex][25]);
