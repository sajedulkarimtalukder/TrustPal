...
public class FriendResult_old extends Activity {
    ...
    public static int unfriendReason=0;
    ...
    private void loadViews() {
        ...
        ignoreButton.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                friendsPage.friendsArray[currentPictureIndex][3] = "0"; //Setting the value as the user did not take the action
                ...
                for (int i = 0; i < radioButtons.size(); i++) {
                    ...
                    btnDismiss.setOnClickListener(new Button.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            if(clickcount!=1) {
                                Toast.makeText(FriendResult_old.this, "Please select any reason!", Toast.LENGTH_SHORT).show();
                            }
                            else {

                                friendsPage.friendsArray[currentPictureIndex-1][6] = Integer.toString(unfriendReason); //Setting the value as the user took the action
                    ...
                    popupWindow.showAsDropDown(unfollowText);
        ...
        actionButton.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                next_button_time = System.nanoTime();
                double difference = (next_button_time - start_time) / 1e6;
                friendsPage.friendsArray[currentPictureIndex][3] = "1"; //Setting the value as the user took the action
                friendsPage.friendsArray[currentPictureIndex][5] = Double.toString(difference); //Setting the value whether the user took the action
    ...
    private void doLastJob() {
        ...
        dialog = ProgressDialog.show(FriendResult_old.this, "", "Uploading file...", true);
            ...
            try {
                ...
                runOnUiThread(new Runnable() {
                    public void run() {
                        ...
                        Toast.makeText(FriendResult_old.this, "MalformedURLException", Toast.LENGTH_SHORT).show();
                    }
                });
                ...
                runOnUiThread(new Runnable() {
                    public void run() {
                        ...
                        Toast.makeText(FriendResult_old.this, "Got Exception : see logcat ",
