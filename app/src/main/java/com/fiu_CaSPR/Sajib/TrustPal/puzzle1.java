...
public class puzzle1 extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        name11.setText(friendsPage.friendsArray[0][1]);
        name21.setText(friendsPage.friendsArray[1][1]);
        name31.setText(friendsPage.friendsArray[2][1]);
        name41.setText(friendsPage.friendsArray[3][1]);

        new FacebookGetUserImage(FriendSelectorView1.imageUrl,11).execute(friendsPage.friendsArray[0][0]);
        new FacebookGetUserImage(FriendSelectorView1.imageUrl,12).execute(friendsPage.friendsArray[1][0]);
        new FacebookGetUserImage(FriendSelectorView1.imageUrl,13).execute(friendsPage.friendsArray[2][0]);
        new FacebookGetUserImage(FriendSelectorView1.imageUrl,14).execute(friendsPage.friendsArray[3][0]);
        ...
        name12.setText(friendsPage.friendsArray[0][1]);
        name22.setText(friendsPage.friendsArray[1][1]);
        name32.setText(friendsPage.friendsArray[2][1]);
        name42.setText(friendsPage.friendsArray[3][1]);

        new FacebookGetUserImage(FriendSelectorView1.imageUrl,15).execute(friendsPage.friendsArray[0][0]);
        new FacebookGetUserImage(FriendSelectorView1.imageUrl,16).execute(friendsPage.friendsArray[1][0]);
        new FacebookGetUserImage(FriendSelectorView1.imageUrl,17).execute(friendsPage.friendsArray[2][0]);
        new FacebookGetUserImage(FriendSelectorView1.imageUrl,18).execute(friendsPage.friendsArray[3][0]);
