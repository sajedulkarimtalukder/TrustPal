...
public class friendurl1 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        url1= "https://www.facebook.com/" + username + "/about?section=relationship&pnref=about";
        setContentView(R.layout.friend_fetch_1);
    ...
    class LoadListener {
        ...
        public void saveHTML(String html) {
            ...
            try {
                ...
                Intent intent = new Intent(getApplicationContext(), friendurl2.class);
                intent.putExtra("username", username);
                startActivity(intent);


            } catch (IOException e) {
                Toast.makeText(friendurl1.this, "File Creation Failed. Reason:" + e.toString(), Toast.LENGTH_SHORT).show();
