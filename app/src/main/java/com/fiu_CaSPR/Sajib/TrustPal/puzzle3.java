...
public class puzzle3 extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        name11.setText(friendsPage.friendsArray[8][1]);
        name21.setText(friendsPage.friendsArray[9][1]);
        name31.setText(friendsPage.friendsArray[10][1]);
        name41.setText(friendsPage.friendsArray[11][1]);

        new FacebookGetUserImage(FriendSelectorView3.imageUrl, 31).execute(friendsPage.friendsArray[8][0]);
        new FacebookGetUserImage(FriendSelectorView3.imageUrl, 32).execute(friendsPage.friendsArray[9][0]);
        new FacebookGetUserImage(FriendSelectorView3.imageUrl, 33).execute(friendsPage.friendsArray[10][0]);
        new FacebookGetUserImage(FriendSelectorView3.imageUrl, 34).execute(friendsPage.friendsArray[11][0]);
        ...
        name12.setText(friendsPage.friendsArray[8][1]);
        name22.setText(friendsPage.friendsArray[9][1]);
        name32.setText(friendsPage.friendsArray[10][1]);
        name42.setText(friendsPage.friendsArray[11][1]);

        new FacebookGetUserImage(FriendSelectorView3.imageUrl, 35).execute(friendsPage.friendsArray[8][0]);
        new FacebookGetUserImage(FriendSelectorView3.imageUrl, 36).execute(friendsPage.friendsArray[9][0]);
        new FacebookGetUserImage(FriendSelectorView3.imageUrl, 37).execute(friendsPage.friendsArray[10][0]);
        new FacebookGetUserImage(FriendSelectorView3.imageUrl, 38).execute(friendsPage.friendsArray[11][0]);
