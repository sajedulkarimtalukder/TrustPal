...
public class puzzle2 extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        name11.setText(friendsPage.friendsArray[4][1]);
        name21.setText(friendsPage.friendsArray[5][1]);
        name31.setText(friendsPage.friendsArray[6][1]);
        name41.setText(friendsPage.friendsArray[7][1]);

        new FacebookGetUserImage(FriendSelectorView2.imageUrl, 21).execute(friendsPage.friendsArray[4][0]);
        new FacebookGetUserImage(FriendSelectorView2.imageUrl, 22).execute(friendsPage.friendsArray[5][0]);
        new FacebookGetUserImage(FriendSelectorView2.imageUrl, 23).execute(friendsPage.friendsArray[6][0]);
        new FacebookGetUserImage(FriendSelectorView2.imageUrl, 24).execute(friendsPage.friendsArray[7][0]);
        ...
        name12.setText(friendsPage.friendsArray[4][1]);
        name22.setText(friendsPage.friendsArray[5][1]);
        name32.setText(friendsPage.friendsArray[6][1]);
        name42.setText(friendsPage.friendsArray[7][1]);

        new FacebookGetUserImage(FriendSelectorView2.imageUrl, 25).execute(friendsPage.friendsArray[4][0]);
        new FacebookGetUserImage(FriendSelectorView2.imageUrl, 26).execute(friendsPage.friendsArray[5][0]);
        new FacebookGetUserImage(FriendSelectorView2.imageUrl, 27).execute(friendsPage.friendsArray[6][0]);
        new FacebookGetUserImage(FriendSelectorView2.imageUrl, 28).execute(friendsPage.friendsArray[7][0]);
